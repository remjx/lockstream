...
const unlockLockScript = (txHex, inputIndex, lockTokenScript, satoshis, privkey) => {
    console.log('unlockLockScript params', txHex, inputIndex, lockTokenScript, satoshis, privkey)
    ...
    console.log('preimg inputs', tx, sighashType, inputIndex, scriptCode, value)
...
const unlockCoins = async(pkWIF, receiveAddress, txid, oIdx = 0) => {
    console.log('unlockCoins', pkWIF, receiveAddress, txid, oIdx)
    try {
        console.log('getting raw tx', txid)
